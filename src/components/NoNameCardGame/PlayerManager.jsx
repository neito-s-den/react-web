...
function PlayerManager({ onAddPlayerClicked, onRemovePlayerClicked, players }) {
    ...
    const addPlayer = () => {
        ...
        !players.includes(player) ? onAddPlayerClicked(player) : alert('Player already exists');
        setPlayer("");
    }
    ...
    return (
        <div className={styles.root}>
            <div className={styles.nameInput}>
                ...
                <button onClick={addPlayer} disabled={!player}>Add player</button>
            </div>
                ...
                {players.map((player, index) => (
                    <div key={index} className={styles.player}>
                        ...
                        <div className={styles.trashIcon}>
                            <FontAwesomeIcon icon={faTrash} onClick={() => {removePlayer(index)}}/>
                        </div>
                    </div>
                ))}
            </div>
